...
```{r functions and necessary requisities, warning=F, message=F, include = 'F', results = 'hide'}
...
number_pcs = paste("PC", seq(1, params$number_pcs), sep="")
...
tile_plot(neighbors_cosine %>%
          ...
          params$game_id)+
        ylab("Games")+
        ggtitle("Why are Games Considered Similar?",
