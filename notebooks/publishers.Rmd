...
Which publishers have the largest effect on a game's average? Users rated? 
...
To get an estimate of each publisher's partial effect on an outcome, I regress

That is, which publisher has the largest partial effect on a game's average rating conditional on 

```{r partial effects of publishers}
