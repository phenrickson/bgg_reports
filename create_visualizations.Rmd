...
```{r user ratings over time, warning=F, message=F}
...
active_games %>%
        ...
        ggtitle("Are Games Getting Better?",
                subtitle = str_wrap("Boardgamegeek average rating for games released since 1930, filtering to games with at least ten user ratings. Blue line indicates fit from local regression.", 90))+
        my_caption+
...
```{r user ratings vs average, warning=F, message=F}
...
```{r examine average and baverage by family type, warning=F, message=F, fig.height=10, fig.width=10}
...
```{r examine average and baverage by category,  warning=F, message=F, fig.height=10, fig.width=10}
...
```{r now look at mechanics, fig.height=10, fig.width=10}
...
```{r get stuff from the linear models for average, fig.height=10, fig.width=10}
...
```{r get stuff from the linear models for usersrated, fig.height=10, fig.width=10}
...
```{r examine the computed shapley values, fig.width=10, fig.height=10, warning=F}
